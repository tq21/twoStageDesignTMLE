...
library(nleqslv)
imp_plugin_logistic <- function(Y, A, W, W_all, Delta.W, W.stage2, pool=TRUE,
  ...
  fn <- function(args) {
    ...
    psi <- mean(Delta.W/res.twoStage$pi*(Q1W_eps-Q0W_eps))
    score_1 <- mean(Delta.W/res.twoStage$pi*(DFullNC_eps-DFullNCReg_gamma))
